...
# Note that the value of L have changed, so the calculation will give you different results
(m <- L * (r/1200) *(1+r/1200)^N / ((1 + r/1200)^N - 1))
```
...
In any case, if you did things correctly you should get 886.4122051  to be paid per month, and paid an extra 1273.8929213  to your banker to get access to that money immediately !
