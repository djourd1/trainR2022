...
```
##             [,1]       [,2]      [,3]      [,4]       [,5]
## row_1  1.9211059 -0.5377386 0.1727964 -1.349382 -0.3106437
## row_2 -0.3817356  0.4438438 0.4456105 -1.431383  1.2422670
## row_3  0.9281413  0.8320622 0.4099465  1.247669 -0.3144409
## row_4 -1.6254245  0.4100944 0.5464723 -3.619193  0.6386614
```
{{< /spoiler >}}
...
So far, we have used the function solve with one argument, the matrix to be inversed.
However, solve can be used to solve systems of linear equations.

Use the function solve() to resolve the following system of equation
...
The problem is a generic algebra problem such as A.x = b where A is the matrix, and x and b are vectors.

So let's create the square matrix A and the vector b
...
## [1] 1.0 0.5
```
Now we can find the vector sol = (u,t) using the function solve
